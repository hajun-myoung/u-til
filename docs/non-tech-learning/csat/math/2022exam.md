...
<img :src="$withBase('images/non-tech/2022exam-03-001.png')" style="width:80%; min-width: 250px; display: block; margin: 0px auto;">
...
예를 들어, $x$에 대해 $a \rightarrow b$ 범위를 적분했다면 $t=g(x)$에 대해서 $g(a) \rightarrow g(b)$의 범위에서 적분하면 되는 것이다.
:::
